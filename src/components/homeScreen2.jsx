...
function Home2() {
  ...
  return (
    ...
    <div class='row' style={{ padding: '0 0 0 0', margin: '0 0 0 0' }}>
     <div class="col-md-6 " id="intro2" style={{ padding: '0 0 0 0', margin: '0 0 0 0' }}>
      <img src={imgb} class="img-fluid " style={{width: '200px', margin: '15px 15px 15px 15px'}} alt="..."></img>
     <div style={{ padding: '15px 15px 15px 15px'}}>
      <video className="w-100 border rounded "  autoPlay muted loop >
            <source src={bg} type="video/mp4" className="w-100 " />
    </video>
      ...
      <div class="col-md-6" style={{ padding: '0 0 0 0', margin: '0 0 0 0' }}>
        <nav class="navbar navbar-light  " style={{ backgroundcolor: 'red', padding: '10px 0 0 0' }}>
  ...
  <iframe src="https://www.youtube.com/embed/vlDzYIIOYmM" title="YouTube video" className="rounded"  allowfullscreen></iframe>
</div>
          <h3 class="text-center " style={{marginTop: '15px'}}>Why Choose Us?</h3>
          </div>
